...
${OBJECTDIR}/src/conversions.o: src/conversions.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/conversions.o src/conversions.cpp

${OBJECTDIR}/src/msg_classes.o: src/msg_classes.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/msg_classes.o src/msg_classes.cpp
...
${OBJECTDIR}/src/conversions_nomain.o: ${OBJECTDIR}/src/conversions.o src/conversions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/conversions_nomain.o src/conversions.cpp;\
	else  \
...
${OBJECTDIR}/src/msg_classes_nomain.o: ${OBJECTDIR}/src/msg_classes.o src/msg_classes.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/msg_classes_nomain.o src/msg_classes.cpp;\
	else  \
